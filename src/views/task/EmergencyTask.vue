<template>
  <el-form :inline="true" :model="formInline" class="demo-form-inline">
    ...
    <el-container>
      <el-main>
        <el-table :data="tasklist" style="width: 100%" border fit highlight-current-row>
          <el-table-column prop="taskorigin" label="任务类型" width="100" align="center"></el-table-column>
          <el-table-column prop="taskid" label="任务ID" width="250" align="center"></el-table-column>
          <el-table-column prop="taskname" label="任务名称" width="250" align="center"></el-table-column>
          <el-table-column prop="taskenv" label="任务执行环境" width="200" align="center"></el-table-column>
          <el-table-column prop="taskexecuteid" label="任务执行ID" width="200" align="center"></el-table-column>
          <el-table-column prop="taskdate" label="任务执行日期" width="150" align="center"></el-table-column>
          <el-table-column prop="iscomplete" label="是否已全部分析完" width="150" align="center"></el-table-column>
          <el-table-column prop="taskfrequency" label="任务通知频率" width="150" align="center"></el-table-column>
          <el-table-column label="操作" width="180" align="center">
            <template slot-scope="tasklist">
              <el-button
                ...
                icon="el-icon-edit"
                size="mini"
                @click="editdatas(tasklist.row.fid)"
              ></el-button>
              ...
              <el-button
                ...
                icon="el-icon-delete"
                size="mini"
                @click="deletedatas(tasklist.row.fid)"
              ></el-button>
            </template>
          </el-table-column>
        </el-table>
    ...
    <el-container>
      <el-main>
        <el-dialog title="新增任务" :visible.sync="addtaskvis" width="30%" @close="addclose">
          <el-form :model="addmsg" :rules="addrule" ref="addref" label-width="120px">
            <el-form-item label="任务类型" prop="taskorigin" >
              <el-input v-model="addmsg.taskorigin"></el-input>
            </el-form-item>
            <el-form-item label="任务ID" prop="taskid">
              <el-input v-model="addmsg.taskid"></el-input>
            </el-form-item>
            <el-form-item label="任务名称" prop="taskname">
              <el-input v-model="addmsg.taskname"></el-input>
            </el-form-item>
            <el-form-item label="任务执行环境" prop="taskenv">
              <el-input v-model="addmsg.taskenv"></el-input>
            </el-form-item>
            <el-form-item label="任务执行ID" prop="taskexecuteid">
              <el-input v-model="addmsg.taskexecuteid"></el-input>
            </el-form-item>
            <el-form-item label="任务执行日期" prop="taskdate">
              <el-input v-model="addmsg.taskdate"></el-input>
            </el-form-item>
            <el-form-item label="任务通知频率" prop="taskfrequency">
              <el-input v-model="addmsg.taskfrequency"></el-input>
            </el-form-item>
          </el-form>
        ...
        <el-dialog title="编辑任务" :visible.sync="edittaskvis" width="30%" @close="editclose">
          <el-form :model="editmsg" :rules="editrule" ref="editref" label-width="120px">
            <el-form-item label="任务类型" prop="taskorigin" >
              <el-input v-model="editmsg.taskorigin"></el-input>
            </el-form-item>
            <el-form-item label="任务ID" prop="taskid">
            ...
            <el-form-item label="任务执行环境" prop="taskenv">
              <el-input v-model="editmsg.taskenv"></el-input>
            </el-form-item>
            <el-form-item label="任务执行ID" prop="taskexecuteid">
              <el-input v-model="editmsg.taskexecuteid"></el-input>
            </el-form-item>
            <el-form-item label="任务执行日期" prop="taskdate">
              <el-input v-model="editmsg.taskdate"></el-input>
            </el-form-item>
            <el-form-item label="任务通知频率" prop="taskfrequency">
              <el-input v-model="editmsg.taskfrequency"></el-input>
            </el-form-item>
          </el-form>
  ...
  data() {
    return {
      ...
      addrule: {
        ...
        taskexecuteid: [{ required: true, message: "任务执行ID", trigger: "blur" }],
        taskdate: [{ required: true, message: "任务执行日期", trigger: "blur" }],
        taskfrequency: [{ required: true, message: "任务通知频率", trigger: "blur" }],
      },
